...
## THE IRONSWORN SYSTEM (BADLANDS FLAVORED)

### The Action Roll

Every meaningful, uncertain action is resolved with three dice:

- **1d6 + the relevant stat** = your Action Score
- **2d10** = the Challenge Dice (rolled separately, compared individually)

Results:

- **Strong Hit** (beat both d10s): You succeed. Take +1 momentum and any move bonus.
- **Weak Hit** (beat one d10): You succeed, but face a complication or cost.
- **Miss** (beat neither): Something goes wrong. **Pay the Price.**
...
- **Health**: Physical condition. Starts at 5.
- **Spirit**: Mental/emotional state. Starts at 5.
- **Supply**: Gear, ammunition, provisions. Starts at 5.
- **Momentum**: Accumulated advantage. Starts at +2. Can be burned to replace a bad Action Score (use current momentum value instead of the roll, then reset to +2).

### Debilities

Conditions that impose -1 max momentum each:

- **Wounded** (health damage), **Shaken** (spirit damage), **Unprepared** (supply gone)
...
**Face Danger** — Risky action or reacting to a threat. Roll the most fitting stat.

- Strong hit: You succeed. +1 momentum.
- Weak hit: Success with cost (delay, new danger, -1 momentum, or 1 harm/stress).
- Miss: Pay the Price.

**Secure an Advantage** — Assess, prepare, gain leverage before acting.

- Strong hit: Take control (make another move now, +1) OR take +2 momentum.
...
**Resupply** — Forage, scavenge, or trade for provisions. Roll +wits.

**Make Camp** — Rest and recover. Roll +supply.

**Undertake a Journey** — Travel across dangerous or uncertain ground. Roll +wits. Each leg fills a progress track; when ready, **Reach Your Destination** (progress roll, no stat modifier).

### Relationship Moves

**Compel** — Persuade, threaten, or trick someone into doing something.

- Charm/convince: Roll +heart
- Threaten: Roll +iron
- Deceive/manipulate: Roll +shadow
- Strong hit: They do it.
- Weak hit: They comply, but want something first.
- Miss: They refuse or it backfires.
...
**Draw the Circle** *(Badlands revised)* — When you challenge someone to a formal duel, or accept a challenge. Roll +heart. If you share a bond with this community, add +1.

- Strong hit: +1 momentum. Choose up to two boasts, +1 momentum each.
...
**Sojourn** — Rest and recover in a town. Roll +heart (or +heart +1 if you have a bond there).

### Badlands-Specific Moves

**Follow the Path** — When you travel a well-known path that may still hold danger, name your destination and roll.

- Travel at speed: Roll +edge
- Travel cautiously: Roll +wits
- Travel with a group: Roll +heart
- Strong hit: Journey is efficient and safe. Take +1 momentum.
- Weak hit: You reach your destination, but not without incident. Pay the Price.
- Miss: Lost or waylaid. Pay the Price; when you continue you must Undertake a Journey instead.

*GM note*: Use Follow the Path for travel between named locations on established routes — roads, trails, rail lines. Use Undertake a Journey for wilderness travel or when the path itself is uncertain.

**Ride the Rails** — When you take a passenger train between two stations, treat as Follow the Path but instead of rolling +stat, roll +supply spent on the ticket. Range: 0 supply (stowing away in cargo) to 5 supply (private car). Interpret results normally.
...
- Strong hit: Vow complete. Mark experience (troublesome=1 XP, dangerous=2, formidable=3, extreme=4, epic=5).
- Weak hit: Mostly done, but something remains or a new complication emerges. Mark reduced XP.
- Miss: The vow is undone or something has gone badly wrong.

**Forsake Your Vow** — If you abandon a promise. Endure Stress (-spirit equal to vow rank). Clear the vow.

**Advance** — When you spend experience. Pay 2 XP to upgrade an existing asset (mark the next ability). Pay 3 XP to add a new asset.

### Combat Moves

**Enter the Fray** — Establish who has initiative at the start of a fight. Roll based on how you enter:

- Alert and ready: Roll +wits
- Facing a threat head-on: Roll +heart
- Ambush or surprise: Roll +shadow

**Strike** — Attack when you have initiative. Roll +edge (ranged) or +iron (melee).

- Strong hit: Mark progress + deal harm. Keep initiative.
- Weak hit: Mark progress, but you expose yourself. Lose initiative.

**Clash** — Fight when the enemy has initiative.

- Strong hit: Mark progress, regain initiative.
- Weak hit: Both sides trade harm.

**Turn the Tide** — When things are desperate, a bold action lets you act even without initiative.
...
**Aid Your Ally** — When you Secure an Advantage in direct support of an ally, and score a hit, they (instead of you) take the benefits. Included for completeness; Jake rides alone, so this rarely applies.

### Suffer Moves

**Endure Harm** — When taking physical damage. Roll +health or +iron (take higher).

- Strong hit: Shake it off (-1 momentum) OR embrace the pain (take +1 momentum).
- Weak hit: Press on.
- Miss: Also suffer -1 momentum. If at 0 health, mark wounded or maimed, or Face Death.

**Face Death** — When you are brought to the brink of death. Roll +heart.

- Strong hit: You are badly wounded but survive. Endure Harm (1 harm).
...
- Strong hit: Shake it off (-1 momentum) OR embrace the darkness (take +1 momentum).
- Weak hit: Press on.
- Miss: Also suffer -1 momentum. If at 0 spirit, mark shaken or corrupted, or Face Desolation.

**Face Desolation** — When your spirit is broken. Roll +heart.

- Strong hit: You resist. Take +1 spirit.
- Weak hit: A vision of a dreadful future compels you. Swear an Iron Vow (formidable or extreme) to prevent it, or be lost.
- Miss: You are broken. Give up or Face Death.

**Out of Supply** — When supply hits 0. Mark unprepared. All moves using supply are at -1 until you Resupply.

**Face a Setback** — When momentum is at -6 and you must suffer further -momentum. Lose health, spirit, or supply equal to remaining loss instead.
...
|Roll |Result                                                                                                                                                          |
|-----|----------------------------------------------------------------------------------------------------------------------------------------------------------------|
|1–2  |Roll again and apply that result but make it worse. If you roll this again, think of something dreadful that changes the course of the quest and make it happen.|
...
**Ask the Oracle** — When you need to determine something uncertain. Roll d100 against a likelihood:

- Almost Certain: 11+ = yes
- Likely: 26+ = yes
- 50/50: 51+ = yes
- Unlikely: 76+ = yes
- Small Chance: 91+ = yes
...
## PROGRESS TRACKS IN DETAIL

All progress tracks — vows, foes, journeys — are always **10 boxes**. Each box takes 4 ticks to fill. What varies by rank is how much progress you mark per milestone or hit.

|Rank       |Progress marked per milestone/hit|
|-----------|---------------------------------|
...
For the **progress roll** (Fulfill Your Vow, End the Fight, Reach Your Destination): count only fully filled boxes as your progress score. Roll 2d10 and compare — no stat added, momentum cannot be burned.

Foes have their own progress track at an appropriate rank. Each point of harm you inflict marks progress against them per the table above.

-----

## EXPERIENCE & ADVANCEMENT

- Mark XP when you Fulfill a Vow (amount based on rank above).
- **Advance** (spend 2 XP): Upgrade an existing asset ability (check a box on the asset card).
- **Advance** (spend 3 XP): Add a new asset.
- Starting assets (3 at character creation) should include the **Drifter** path asset (see below).
